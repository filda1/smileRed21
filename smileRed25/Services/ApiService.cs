...
namespace smileRed25.Services
{
    public class ApiService
    {
        ...
        public async Task<Order> GetOrderByEmail(
         string urlBase,
         string servicePrefix,
         string controller,
         string tokenType,
      ...
      /*  public async Task<InstagramResponse> GetInstagram(string accessToken)
        ...
        var url = apiSecurity + "/" + "Orders1/";
         ...
         var json = JsonConvert.SerializeObject(orderN);
          ...
          client.DefaultRequestHeaders.Authorization =
                  new AuthenticationHeaderValue(tokenType, accessToken);
          var response = await client.PutAsync(string.Concat("http://aurora.somee.com/api/Orders1/", id), content);
      ...
      var url = apiSecurity + "/" + "Orders1/";
       ...
       var json = JsonConvert.SerializeObject(orderN);
        ...
        client.DefaultRequestHeaders.Authorization =
                new AuthenticationHeaderValue(tokenType, accessToken);
        var response = await client.PostAsync("http://aurora.somee.com/api/Orders1", content);
       ...
       var url = apiSecurity + "/" + "Orders1/";
        ...
        var response = await client.GetStringAsync("http://aurora.somee.com/api/Orders1");

        var list = JsonConvert.DeserializeObject<List<Order>>(response);
       ...
       var url = apiSecurity + "/" + "Orders1/";
        ...
        var response = await client.DeleteAsync(string.Contac("http://aurora.somee.com/api/Orders1/",id));
